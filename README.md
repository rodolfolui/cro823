# IBM Resilency Orchestration 8.2.3 container
...
## Introduction to Resilency Orchestration 8.2.3
...
localhost/cro                        8.2.3         05fc28b5ad50  2 minutes ago   4.15 GB
...
- instcro            RO installation script
       ...
       STEP 2/17: ENV HOME=/var/lib/mysql     SUMMARY="MariaDB 10.5.9 Tomcat 9.0.54 Panaces 8.2.3"     DESCRIPTION="Resilency Orchestration 8.2.3"
       --> c94d5c9735f
       STEP 2/19: ENV HOME=/var/lib/mysql     SUMMARY="MariaDB 10.5.9 Tomcat 9.0.54 Panaces 8.2.3"     DESCRIPTION="Resilency Orchestration 8.2.3"
       --> Using cache c94d5c9735fc39773070cd2f740d5dcb549c0e212e946f91aa179c94251c88c8
       --> c94d5c9735f
       STEP 3/19: LABEL summary="$SUMMARY"       description="$DESCRIPTION"       io.k8s.description="$DESCRIPTION"       io.k8s.display-name="CRO 8.2.3"       io.openshift.expose-services="3306:mysql,8080:tomcat"       io.openshift.tags="database,mysql,mariadb,mariadb105,mariadb-105"       com.redhat.component="mariadb-105-container"       name="cro829"       version="1"       usage="docker run -it -e DISPLAY=$DISPLAY --network host -v /tmp/.X11-unix:/tmp/.X11-unix -p 8080:8080 -p 3306:3306 -h crort --name crort cro80 bash"       maintainer="Kyndryl Colombia <rvasquez@kyndryl.com>"
